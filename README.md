...
* - I used Descriptive to get all the data to read and understand the results then i used Diagnostics to further delve into the results to see correlations between factors that influenced costs.
